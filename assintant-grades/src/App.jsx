  ...
  return (
    <>
      ...
      <div id="main">
        ...
        <div style={{display:"flex",gap:"8px",marginTop:"10px",marginBottom:"10px",flexWrap:"wrap"}}><button className="btn btn-primary btn-sm" type="button" onClick={() => callGlobal("loadDocenteFromOasis")}>🔄 Traer docente desde OASIS</button><button className="btn btn-success btn-sm" type="button" onClick={() => callGlobal("loadStudentsFromOasis")}>🔄 Traer estudiantes desde OASIS</button></div>
